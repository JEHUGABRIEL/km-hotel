        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            <h3 className="text-4xl font-serif mb-6 leading-tight">
              Restaurant Soigné & <br /> Bar Lounge Cosy
            </h3>

            <div className="space-y-6 text-slate-300 font-light leading-relaxed mb-8">
              <p>
                Découvrez une expérience culinaire unique dans notre restaurant
                gastronomique. Notre chef vous propose une carte raffinée,
                mêlant avec subtilité les produits locaux de qualité et les
                grands classiques de la cuisine internationale.
              </p>
              <p>
                En fin de journée, notre Bar Lounge vous accueille dans une
                atmosphère feutrée et cosy. Profitez de notre sélection pointue
                offrant une gamme variée de vins, champagnes et spiritueux pour
                vos moments de détente ou vos rendez-vous d'affaires.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-8">
              <div>
                ...
                <p className="text-sm text-slate-400">06:30 - 10:00</p>
              </div>
              <div>
                <p className="font-serif text-xl text-white mb-1">Dîner</p>
                <p className="text-sm text-slate-400">19:00 - 22:30</p>
              </div>
            </div>
          </motion.div>
