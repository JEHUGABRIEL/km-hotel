        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-600 font-light">
              Un design raffiné et un confort moderne pour un séjour inoubliable
              au cœur de Bangui. Toutes nos chambres bénéficient de notre
              autonomie électrique et hydraulique.
            </p>
          </div>
          <a
            href="#contact"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            <p className="text-slate-500 font-light mb-4">
              Lit Queen Size, Espace bureau, Wi-Fi haut débit, Climatisation.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            <p className="text-slate-500 font-light mb-4">
              Lit King Size, Coin salon séparé, Vue sur la ville, Prestations
              VIP.
            </p>
          </motion.div>
        </div>
